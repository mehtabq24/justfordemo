...

{
    ...
    //public function __construct($host = 'localhost', $username = 'awebsolu_gem', $password = 'AB!}0[8JeGe&', $db = 'awebsolu_crm', $port = NULL, $charset = 'utf8')

    public function __construct($host = 'localhost', $username = 'hpluss_hpluss_hilgroup_admin', $password = 'YtqsgpAqwYP-', $db = 'hpluss_hilgroup', $port = NULL, $charset = 'utf8')
 ...
 public function encode($strpass)
    {
        return  base64_encode(str_rot13(gzdeflate(base64_encode(str_rot13(gzdeflate(base64_encode(str_rot13(gzdeflate(base64_encode(str_rot13(gzdeflate(str_rot13($strpass)))))))))))));
    }
     public function decode($strpass)
    {
        return  str_rot13(gzinflate(str_rot13(base64_decode(gzinflate(str_rot13(base64_decode(gzinflate(str_rot13(base64_decode(gzinflate(str_rot13(base64_decode($strpass)))))))))))));;
    }
...

    {
        ...
        return "UPDATE " . self::$_prefix . $tableName;
